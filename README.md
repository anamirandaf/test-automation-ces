...
✔ Suite por Clase
ID	Test	Estado
1	Test01_CrearAdmin	OK
2	Test02_CrearTester	OK
✔ Suite por Paquete
ID	Test	Estado
1	Test01_CrearAdmin	OK
2	Test02_CrearTester	OK
3	Test03_BorrarCuentaTester	OK
4	Test05_ReiniciarPass	OK
✔ Suite por Tags
ID	Test	Estado	Tag
1	Test05_ReiniciarPass	OK	@regresion
📈 Reportes
...
Evidencias visuales (si aplica)
📌 Conclusión

Este framework proporciona una solución robusta, mantenible y escalable para asegurar la calidad del sistema mediante automatización de pruebas, permitiendo:
